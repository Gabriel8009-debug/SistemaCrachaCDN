...
from .path_manager import CONFIG, LOGS

COORDENADAS_PADRAO = CONFIG / "sisweb_coordenadas.json"
REGIOES_PADRAO = CONFIG / "sisweb_regioes.json"
DEBUG_PADRAO = LOGS / "sisweb_debug"
